...
namespace CourseDesktopClient
{
    public class StructureProgramm
    {
        public static void RegisterServices(IServiceCollection services)
        {
            ...
            services.AddTransient<TestResultPageVm>();
            services.AddTransient<CreateUserPageVm>();
            ...
            services.AddTransient<GerenateReportUserPageVm>();
            ...
            services.AddTransient(provider =>
            {
                var gerenateReportUserPageVm = provider.GetRequiredService<GerenateReportUserPageVm>();
                return new GerenateReportUserPage { DataContext = gerenateReportUserPageVm };
            });

            services.AddTransient(provider =>
            {
                var testResultPageVm = provider.GetRequiredService<TestResultPageVm>();
                return new TestResultPage { DataContext = testResultPageVm };
            });
            ...
            services.AddTransient(provider =>
            {
                var createUserPageVm = provider.GetRequiredService<CreateUserPageVm>();
                return new CreateUserPage { DataContext = createUserPageVm };
            });
