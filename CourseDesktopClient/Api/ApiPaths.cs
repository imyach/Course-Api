...
namespace CourseDesktopClient.Api
{
    public class ApiPaths
    {
        ...
        public const string API_GET_ALL_MATERIAL = "matherial/all";
        public const string API_GET_MATERIAL_BY_ID = "matherial/";
        public const string API_DELETE_UPDATE_CERATE_MATERIAL = "matherial";
